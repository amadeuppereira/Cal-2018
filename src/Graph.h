...
class Vertex {
	...
	bool visited;
	/**
	 * indegree do vertice para a ordena��o topologica
	 */
	int indegree;
	/**
	 * nome do vertice
...
public:
	...
	/**
	 *
	 * @return returna a informa��o do vertice
	 */
	T getInfo() const;
	/**
	 *
	 ...
	 * @param tw se � de 2 sentidos a estrada
...
public:
	 ...
	 * @param w peso da aresta
	 * @param tw se � uma aresta de 2 sentidos
	 * @param n nome da aresta
	 * @param id id da aresta
	...
	/**
	 *
	 * @return returna se a aresta � de dois sentidos
	 */
	...
	/**
	 *
	 * @return returna a quantidade de carros que est�o na aresta
	 */
...
public:
	 ...
	 * @return returna o index do vertice no vector de vertices ou -1 caso n�o exista
	 */
	 ...
	 * @param in id do vertice
	 * @return true caso exista e removido ou false caso n�o exista
	 */
	 ...
	 * @param w peso da aresta
	 * @param tw se a aresta � de 2 sentidos
	 * @param n nome da aresta
	 * @param id id da aresta
	 ...
	 * @param sourc id de inicio da aresta
	 * @param dest id de destino da aresta
	 * @return true caso exista e retire ou false caso n�o exista
	 */
	...
	/**
	 * Faz uma organiza��o topologica do grafo
	 * @return returna um vetor com a organiza��o topologica
	 */
